...
instructions:
  - "Break frozen acai packets into chunks. Run under warm water for 10 seconds to soften slightly."
  - "Add acai, frozen bananas, frozen berries, and milk to blender."
  - "Blend on low, using tamper to push ingredients down. Add more liquid only if absolutely needed - you want it THICK!"
